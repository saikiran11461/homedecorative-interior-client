...
import { pages, getContactPageSchema, getLocalBusinessSchema } from "@/lib/seo-config";
    ...
    <>
      <SEO
        ...
        breadcrumbs={[
          ...
          { name: "Contact", url: "https://www.homedecorativeinterior.com/contact" },
        ]}
        schemas={[getContactPageSchema(), getLocalBusinessSchema()]}
      />
      <div className="bg-background">
        <Navbar />
        <section className="relative pt-32 pb-16 px-6 bg-charcoal overflow-hidden">
          <div className="absolute inset-0 opacity-20">
            <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=2000" className="w-full h-full object-cover" alt="Contact Home Decorative Interior Hyderabad" loading="lazy" />
          </div>
