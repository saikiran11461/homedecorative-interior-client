...
const RegisterPage = () => {
  ...
  return (
    <>
      <SEO page={pages.register} />
      <div className="min-h-screen flex">
        <div className="hidden md:flex w-1/2 relative">
          <div className="absolute inset-0 bg-foreground/30 z-10" />
          <img src="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&q=80&w=1200" className="w-full h-full object-cover" alt="" loading="lazy" />
